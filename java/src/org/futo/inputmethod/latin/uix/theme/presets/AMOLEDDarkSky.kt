...
private val darkScheme = extendedDarkColorScheme(
    ...
    onPrimaryContainer = Color(0xFFC0E5FF),
    secondary = Color(0xFFBBDFFF),
    onSecondary = Color(0xFF003355),
    secondaryContainer = Color(0xFF004766),
    onSecondaryContainer = Color(0xFFBBDFFF),
    ...
    keyboardContainer = Color(0xFF004766).copy(alpha = 0.6f),
    keyboardContainerVariant = Color(0xFF004766).copy(alpha = 0.2f),
    onKeyboardContainer = Color(0xFFE6E1E5).copy(alpha = 0.8f),
    keyboardPress = Color(0xFF003355),
    keyboardFade0 = Color(0xFF000000),
    keyboardFade1 = Color(0xFF000000),
    primaryTransparent = Color(0xFF5CC8FF).copy(alpha = 0.3f),
    onSurfaceTransparent = Color(0xFFE6E1E5).copy(alpha = 0.1f),
)

val AMOLEDDarkSky = ThemeOption(
    dynamic = false,
    key = "AMOLEDDarkSky",
    name = R.string.theme_amoled_dark_sky,
    available = { true }
) {
    darkScheme
}
